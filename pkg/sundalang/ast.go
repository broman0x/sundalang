...
func (nl *NullLiteral) String() string       { return "ewehan" }
...
func (ps *PrintStatement) String() string       { return "cetakkeun " + ps.Expression.String() }
...
func (ie *InputExpression) String() string       { return "tanyakeun" }
...
func (ws *WhileStatement) String() string {
	return "kedap " + ws.Condition.String() + " " + ws.Body.String()
}
...
func (is *ImportStatement) String() string       { return "buka " + is.Path.String() }
...
func (ts *TryStatement) String() string {
	var out bytes.Buffer
	out.WriteString("cobaan ")
	out.WriteString(ts.Block.String())
	if ts.Catch != nil {
		out.WriteString(" sanya ")
